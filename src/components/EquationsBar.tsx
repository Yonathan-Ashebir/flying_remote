...
const Equation = forwardRef<HTMLDivElement, {
    ...
    return (
        <Stack {...rest} ref={ref}
               className={'equation' + (equation.suspended ? ' equation-suspended ' : ' ') + className}
...
const NormalChar = ({
                        ...
                        className = '',
                        ...rest
                    }: { children: ReactNode, className?: string }) => <span {...rest}
                                                                             className={"normal-letter " + className}><span>{children}</span></span>
const VariableChar = ({
                          children,
                          className = '',
                          ...rest
                      }: { children: string, className?: string }) => <span {...rest}
